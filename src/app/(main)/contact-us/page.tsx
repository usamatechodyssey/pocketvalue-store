...
export default async function ContactPage() {
  // --- BUG FIX IS HERE ---
  // The call now uses the correct type 'contact-us' and no longer passes a slug.
  ...
  return (
    <main className="w-full bg-white dark:bg-gray-900">
      <div className="bg-gray-50 dark:bg-gray-800/ ৫০">
...
// --- SUMMARY OF CHANGES ---
// - **Bug Fix:** The call to `getBreadcrumbs` has been corrected from `getBreadcrumbs('page', 'contact-us')` to `getBreadcrumbs('contact-us')`.
// - This now correctly matches the updated logic in the `queries.ts` file, ensuring the breadcrumb trail will render as "Home / Contact Us".
