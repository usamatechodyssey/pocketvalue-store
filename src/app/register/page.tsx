    ...
    <div className="flex justify-center items-center min-h-[80vh] py-12 bg-gray-50 dark:bg-gray-900">
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md focus:ring-brand-primary focus:border-brand-primary"
                />
                {errors.name && (
                  ...
                  {...register("email", {
                    ...
                    validate: {
                      isAllowedDomain: (value) => {
                        ...
                        return (
                          ALLOWED_EMAIL_DOMAINS.has(domain?.toLowerCase()) ||
          ...
          <div className="text-center">
            ...
            <div className="my-6">
              <input
                ...
                className="w-48 text-center text-2xl font-semibold tracking-[10px] bg-gray-100 dark:bg-gray-700 rounded-lg p-3 focus:border-brand-primary focus:ring-brand-primary"
              />
            </div>
            <button
              onClick={onOtpSubmit}
      ...
      <style jsx global>{`
        .phone-input-custom .PhoneInputInput {
          ...
          height: 2.375rem; /* Matches your other inputs (py-2) */
          padding-left: 0.5rem;
        }
