...
//   // --- Security Step 1: Verify Session ---
//   const session = await auth();
//   const userRole = (session?.user as any)?.role;

//   // --- Security Step 2: Verify Role ---
//   // This page is strictly for Super Admins.
//   if (userRole !== 'Super Admin') {
//     // Redirect non-Super Admins to an access denied page or the main dashboard
//     redirect("/access-denied");
//   }

//   // --- Data Fetching ---
//   // Fetch the initial list of admin users on the server.
...
//                 Invite, view, and manage roles for your store's administrative staff.
//             </p>
//         </div>
//       </div>
...
//             <ShieldAlert size={20} className="text-yellow-600 dark:text-yellow-400 mt-0.5 shrink-0" />
//             <div>
//                 <h3 className="font-semibold text-yellow-800 dark:text-yellow-300">
//                   Important Security Notice
//                 </h3>
//                 <p className="text-sm text-yellow-700 dark:text-yellow-400 mt-1">
//                   Only grant admin access to trusted individuals. Store Managers and Content Editors have significant control over your store's operations and content.
//                 </p>
//             </div>
//         </div>
//       </div>
...
//       {/* --- Main Content Area --- */}
//       {/* The interactive list is handled by the Client Component */}
