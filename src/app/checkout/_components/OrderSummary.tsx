...
// //       {/* Title hidden on mobile accordion to avoid duplication */}
// //       {!isMobileView && (
...
// //       {/* Cart Items List */}
// //       <div className="space-y-4 max-h-[350px] overflow-y-auto pr-2 custom-scrollbar divide-y divide-gray-100 dark:divide-gray-800">
// //         {cartItems.map((item) => (
// //           <div
// //             key={item.cartItemId}
// //             className="flex items-start gap-4 pt-4 first:pt-0"
...
//   // ✅ FIX: Agar mounted nahi hai to "Empty" dikhao (Server match ke liye)
