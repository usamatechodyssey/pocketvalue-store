      ...
      <div className="flex flex-col gap-4 mt-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <button
            ...
            className="flex-grow flex items-center justify-center gap-2 px-6 py-3.5 bg-brand-primary text-on-primary font-bold rounded-lg shadow-md hover:bg-brand-primary-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={!isSelectionInStock}
            className="flex-grow flex items-center justify-center gap-2 px-6 py-3.5 bg-brand-secondary text-white font-bold rounded-lg shadow-md hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Buy Now
          </button>
        </div>
