...
export default function ThemeSwitcher() {
  ...
  // 🔥 FIX: Avoid Synchronous Cascading Updates
  // setTimeout(..., 0) use karne se ye update 'next tick' par chali jati hai.
  // Is se "Cascading Render" ka error khatam ho jata hai aur app fast load hoti hai.
  useEffect(() => {
  ...
  if (!mounted) {
    return <div className="h-12 w-12 rounded-xl bg-transparent" />; 
  }
